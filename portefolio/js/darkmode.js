...
check.addEventListener('click', () =>{
    ...
    localStorage.getItem("mode") == "true" ? (localStorage.setItem("mode","false"), document.body.classList.add('dark-theme'))
: (localStorage.setItem("mode","true"), document.body.classList.remove('dark-theme'));
    console.log(localStorage.getItem("mode"));
